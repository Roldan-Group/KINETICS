...
class RConstants:
	...
	def activation(process, systems):
		...
		print(process['ts'], process['reactants'])
...
class REquations:
	def __init__(self, processes, systems):
		...
		self.printdata(print_constemperature, print_surfequations, 'Cons_Temperature')
		self.printdata(print_tpd, print_surfequations, 'TPD')
...
#>>>>>>>>>>>>>>   HOW TO INCLUDE "SURF"? or better SURF[site]?
	...
	@staticmethod
	def printdata(equations, surf_equations, experiment):
